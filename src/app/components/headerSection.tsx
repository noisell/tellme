    ...
    <div className='flex flex-col w-full h-auto items-center bg-tg-section-color from-cyan-950 to-cyan-800 rounded-b-3xl p-4'>
      <div className='flex w-full mt-2 justify-between items-center'>
        ...
        <div
          ...
          <div className='flex w-full items-center justify-between'>
            ...
            <span>
              {props.countCompletedOrders}
              <span className='text-tg-subtitle-color'>
                /{props.needCountCompletedOrders}
              </span>
            </span>
          </div>
          <Progress
            percent={
              (props.countCompletedOrders / props.needCountCompletedOrders) *
              100
            }
            size={['100%', 10]}
            showInfo={false}
      ...
      <div className='flex flex-col mt-6 items-center'>
        ...
        <span className='mt-2 text-4xl font-medium'>
          {props.incomeToday} <span className='text-tg-subtitle-color'>₽</span>
        </span>
      </div>
    </div>
  )
